...
var definitions = []Definition{
	...
	{ControlStateContract, 1, "保存活动组合、活动内核世代、用户授权与遗忘状态及其耐久修订", []string{"read", "compare_and_swap"}, []string{ControlStateSchema, UserControlStateSchema}, "internal/contract/control.go"},
