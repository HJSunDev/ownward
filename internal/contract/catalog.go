...
var definitions = []Definition{
	...
	{AccessAdapterContract, 2, "把外部协议映射到统一产品能力，不拥有产品语义或写入权", []string{"rules", "create", "create_batch", "update", "read", "read_with_basis", "check_information", "evidence_search", "evidence_read", "search", "navigate", "semantic_work", "semantic_submit", "semantic_status"}, []string{"mcp/2025-06-18"}, "internal/contract/access.go"},
