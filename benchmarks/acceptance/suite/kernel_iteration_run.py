...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--blind-suite-process-budget", type=Path)
...
def main() -> None:
    ...
    if args.stage3_reader_reliability:
        ...
        if any(value is not None for value in (
            ...
            args.blind_suite_process_budget,
        )):
        ...
        if any(value is not None for value in (
            ...
            args.blind_suite_previous_plan_identity, args.blind_suite_previous_adjudication,
            args.blind_suite_process_budget, args.gate_seed,
        )):
        ...
        result = kernel_iteration_blind_suite.run_partition(
            ...
            process_budget_path=args.blind_suite_process_budget,
            resume=args.resume,
        )
